...
import { TvSerie } from 'src/app/modules/pages/tvseries/shared/tvserie.model';
import { EpisodeListModalPage } from 'src/app/modules/pages/episodes/episode-list-modal/episode-list-modal.page';
