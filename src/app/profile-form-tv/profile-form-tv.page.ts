...
declare var window;
@Component({
  selector: 'app-profile-form-tv',
  templateUrl: './profile-form-tv.page.html',
  styleUrls: ['./profile-form-tv.page.scss']
})
export class ProfileFormTvPage extends ParentComponent implements OnInit {
